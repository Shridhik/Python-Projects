...
def day0mat(pop_density, disease_chance, grid_size):    # For day 0 of disease, we will need the population density, and the chances of getting a disease
    """
    Generates a matrix of grid_size x grid_size and each cell is populated based on pop_density probabilty check
    and is either healthy(0) or diseased based on disease_chance probability. This is day0 (initial grid)
    Args:
        pop_density (): probability of the cell in the matrix of grid_size x grid_size is populated
        disease_chance (): probability of the cell that is populated is healthy or diseased
